...
class Node {
 public:
  Node() {}
  Node(const Order& order, const std::size_t &system_index, const NodeType &nodetype);
  Node(const Vehicle& vehicle, const std::size_t &system_index, const NodeType &nodetype);
  ...
  std::size_t system_index = -1;
};

Node::Node(const Order& order, const std::size_t &system_index, const NodeType &nodetype) {
  this->order = order;
  this->system_index = system_index;
  this->nodetype = nodetype;
}
Node::Node(const Vehicle& vehicle, const std::size_t &system_index, const NodeType &nodetype) {
